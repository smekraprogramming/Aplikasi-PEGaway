...
<div class="alert alert-warning">
    <div class="animated pulse infinite"><strong>Penting !</strong> Absen hanya bisa di lakukan 1 kali saja dan tidak bisa di reset. Harap berhati - hati ! </div>
</div>
            ...
            <div class="card profile-card">
                ...
                <div class="profile-body">
                    ...
                    <div class="content-area">
                        ...
                        <p><?=$this->session->userdata('logged_in')['status_user']?> <?= $this->session->userdata('logged_in')['is_admin'] == 1 ? '| Admin' : '' ?>
                        </p>
...
<div class="modal fade" id="defaultModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <input type="hidden" name="ip-client" id="ip-client">
...
//   return (google.maps.geometry.spherical.computeDistanceBetween(p3, p4) / 1); //dividing by 1000 to get Kilometers
// }
...
<script>
    ...
    function detail_data() {
        ...
        method: "GET",
        // dataType:"JSON",
        url: "<?php echo site_url('dashboard/get_detail') ?>",
        })
        .done(function( data ) {    
            // console.log(data);              
    ...
    $("#form-absen").on('submit',function(e) {
        ...
        html: '<strong class="col-red">Catatan : Pastikan jarak lokasi anda keluar terlebih dahulu sebelum klik simpan !</strong>',
        type: 'warning',
        ...
        confirmButtonText: 'Ya, Absen Sekarang !'
            ...
            if (result.value) {
                ...
                processData:false,
                data:formData,
                url: "<?=site_url('dashboard/simpan_absen') ?>",
                })
                .done(function(data) {
                    // console.log(data)
                    if (data=='success') {
